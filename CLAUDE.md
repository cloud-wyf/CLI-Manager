...
This project is indexed by GitNexus as **CLI-Manager** (20252 symbols, 40806 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
