...
export const SETTING_BACKUP_POLICY = {
  ...
  terminalTextColor: "preferences",
  terminalTuiUserColor: "preferences",
  terminalTuiAssistantColor: "preferences",
  ...
  osc52ClipboardQueryEnabled: "excluded",
  ...
  hideCodexRuntimeCursor: "excluded",
  ...
  kimiHookBridgeEnabled: "excluded",
  ...
  taskbarAttentionMode: "preferences",
  taskbarAttentionFlashCount: "preferences",
  ...
  remoteHandoffNotificationsEnabled: "notifications",
  remoteHandoffCompletionNotificationsEnabled: "notifications",
  remoteHandoffPermissionNotificationsEnabled: "notifications",
  remoteHandoffProgressNotificationsEnabled: "notifications",
  remoteHandoffProgressIntervalMinutes: "notifications",
  ...
  kimiHookConfigDir: "excluded",
  piHookConfigDir: "excluded",
